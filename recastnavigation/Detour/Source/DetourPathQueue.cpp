 ...
 * @brief Implementation of a path queue for handling pathfinding requests in Detour.
 */
...
#include "DetourCommon.h"
 ...
 /**
  * @brief Construct a dtPathQueue object.
  */
...
/**
 * @brief Destruct the dtPathQueue object and free allocated memory.
 */
dtPathQueue::~dtPathQueue()
{
	purge();
...
/**
 * @brief Purge the path queue, freeing all allocated memory.
 */
...
/**
 * @brief Initialize the path queue.
 *
 * @param[in] maxPathSize The maximum size of the path array.
 * @param[in] maxSearchNodeCount The maximum number of search nodes.
 * @param[in] nav A pointer to the navigation mesh.
...
/**
 * @brief Update the path queue by processing pathfinding requests.
 *
 * @param[in] maxIters The maximum number of pathfinder iterations to perform in a single update.
 */
...
/**
 * @brief Request a pathfinding query.
 *
 ...
 * @param[in] endPos The ending position.
 * @param[in] filter The query filter.
 * @return A handle to the pathfinding request.
 */
...
/**
 * @brief Get the status of a pathfinding request.
 *
 * @param[in] ref The handle to the pathfinding request.
...
/**
 * @brief Get the result of a pathfinding request.
 *
 * @param[in] ref The handle to the pathfinding request.
 * @param[out] path An array to store the resulting path.
 * @param[out] pathSize The size of the resulting path.
 * @param[in] maxPath The maximum path size.
 * @return The status of the request.
 */
